...
function ClusterIndex() {
  ...
  return (
    <div className="ClusterIndex">
      <div className="ClusterIndex-header">
            ...
            <div className="col-1o2 text-align-right">
              <Link to="/">
                ...
                >
                  ...
                  />
                  <path
                    d="M84.916 41.2465C79.1393 41.2465 77.2619 38.9085 77.2619 32.7712V17.7202H72.063V13.0442H77.2619V4.27658L83.183 2.66919V13.0442H90.2593V17.7202H83.183V31.0177C83.183 35.1092 84.0495 36.2782 86.7934 36.2782C87.9487 36.2782 89.104 36.1321 90.1149 35.8399L90.5482 40.662C89.104 40.9543 86.7934 41.2465 84.916 41.2465Z"
                    fill="#242D5F"
                  />
                  <path
                    d="M117.987 27.3646H100.658C100.513 33.648 103.113 36.4244 108.745 36.4244C111.344 36.4244 114.088 35.8399 116.543 34.817L117.265 39.4931C114.377 40.6621 111.056 41.2466 107.59 41.2466C99.2135 41.2466 94.4478 36.8628 94.4478 27.0723C94.4478 18.7431 99.069 12.4597 107.012 12.4597C114.81 12.4597 118.132 17.7203 118.132 24.0037C118.132 24.8804 118.132 26.1956 117.987 27.3646ZM106.867 16.9896C103.546 16.9896 101.235 19.4738 100.802 23.2731H112.355C112.355 19.4738 110.333 16.9896 106.867 16.9896Z"
                    fill="#242D5F"
                  />
                  <path
                  ...
                  />
                  <path
                    d="M270.635 40.662L261.248 26.6338V40.662H255.327V4.71491C254.027 4.42266 252.15 4.27653 250.561 4.1304V0.477245C253.594 0.184993 257.637 -0.107259 261.248 0.0388677V24.8803L270.057 13.0441H277.278L267.169 25.611L278 40.662H270.635Z"
                    fill="#242D5F"
                  />
                  <path
      ...
      <ThemeFilter>
        <h2>{themes.length} gevonden resultaten</h2>
      </ThemeFilter>
      <div className="ClusterIndex-results">
        <div className="container">
          <div className="row">
            <div className="col-1">
              <h2>{themes.length} gevonden resultaten</h2>
